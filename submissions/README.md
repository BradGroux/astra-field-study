...
There are no participant submissions here yet. The examples in `examples/` are synthetic. The separately reviewed real case in [evidence/](../evidence/brad-groux-six-days-v1/README.md) uses a different versioned format and does not alter the submission contract.
