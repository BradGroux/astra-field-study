...
Evidence directory names and package headings must use neutral study IDs, such as `study-0001-v1` and “Study 0001,” rather than contributor names or identity hashes. Do not publish an ID-to-person mapping. Preserve required license notices and proper public-source attribution. Neutral naming does not erase prior Git history or prevent identification through linked publications. See the [evidence naming rules](observational-evidence-format.md#neutral-study-identifiers).
